...
// CommentCache is the store for Comment
...
// CommentPromise is the promise for Comment
...
// CommentQuerySet is a query struct, using Get to get a single element or GetSlice to get all elements.
